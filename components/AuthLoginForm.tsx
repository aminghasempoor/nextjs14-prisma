        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <FormField
                    ...
                    render={({ field }) => (
                        <FormItem>
                            <FormLabel className={'text-gray-400 text-2xl'}>Confirm Password</FormLabel>
                            <FormControl>
                                <Input className={'w-full'} placeholder="Confirm You're Password" {...field} />
                            </FormControl>
                            <FormMessage />
                        </FormItem>
                    )}
            ...
            <div className={'text-sm text-gray-500 mt-5'}>
                Dont have an account <Link className={'text-white hover:underline ml-1 text-lg'} href={'/sign-up'}>Sign Up Now</Link>
            </div>
            <NextAuthLogin />
        </Form>
    )
